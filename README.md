...
- **Living Pudding Timer:** A pudding gets eaten as the countdown runs — it wobbles when less than 10% remains and bursts into a **sprinkle celebration** with a jingle when time is up. **One-tap presets** (Tea, Coffee, Egg, Nap, Focus) and a **natural-language quick set** ("25m", "1h30m", "90s") save you typing. Pause/resume, desktop notifications, and the timer **survives a page refresh**.
