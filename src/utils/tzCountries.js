...
//
// We deliberately store only the country *code*, not the name: the human name
// comes from Intl.DisplayNames at runtime (localized, and we never have to keep
// names up to date). This is what lets the picker find "Asia/Kuala_Lumpur" when
// someone types "Malaysia".
//
// Both modern and legacy zone ids are included (e.g. Asia/Kolkata AND the older
// Asia/Calcutta that some ICU builds still report), so coverage holds whether
// the platform's Intl.supportedValuesOf returns canonical or legacy names.
export const TZ_COUNTRY = {
  // Africa
  'Africa/Abidjan': 'CI', 'Africa/Accra': 'GH', 'Africa/Addis_Ababa': 'ET',
  'Africa/Algiers': 'DZ', 'Africa/Asmera': 'ER', 'Africa/Asmara': 'ER',
  ...
  'America/Aruba': 'AW', 'America/Asuncion': 'PY', 'America/Bahia': 'BR',
  ...
  'America/Ciudad_Juarez': 'MX', 'America/Coral_Harbour': 'CA', 'America/Cordoba': 'AR',
  ...
  'America/Glace_Bay': 'CA', 'America/Godthab': 'GL', 'America/Nuuk': 'GL',
  ...
  'America/Indiana/Winamac': 'US', 'America/Indianapolis': 'US', 'America/Inuvik': 'CA',
  ...
  'Asia/Calcutta': 'IN', 'Asia/Kolkata': 'IN', 'Asia/Chita': 'RU', 'Asia/Colombo': 'LK',
  ...
  'Asia/Karachi': 'PK', 'Asia/Katmandu': 'NP', 'Asia/Kathmandu': 'NP', 'Asia/Khandyga': 'RU',
  ...
  'Asia/Qyzylorda': 'KZ', 'Asia/Rangoon': 'MM', 'Asia/Yangon': 'MM', 'Asia/Riyadh': 'SA',
  'Asia/Saigon': 'VN', 'Asia/Ho_Chi_Minh': 'VN', 'Asia/Sakhalin': 'RU',
  ...
  'Asia/Tomsk': 'RU', 'Asia/Ulaanbaatar': 'MN', 'Asia/Ulan_Bator': 'MN', 'Asia/Urumqi': 'CN',
  ...
  'Europe/Kiev': 'UA', 'Europe/Kyiv': 'UA', 'Europe/Kirov': 'RU', 'Europe/Lisbon': 'PT',
  ...
  'Europe/Volgograd': 'RU', 'Europe/Warsaw': 'PL', 'Europe/Zagreb': 'HR', 'Europe/Zurich': 'CH',
  ...
  'Pacific/Chatham': 'NZ', 'Pacific/Easter': 'CL', 'Pacific/Efate': 'VU',
  'Pacific/Enderbury': 'KI', 'Pacific/Kanton': 'KI', 'Pacific/Fakaofo': 'TK',
